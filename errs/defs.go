...
var (
	...
	ErrorMiniappUser         = HttpErr{HttpSC: http.StatusOK, Err: Err{Code: 10023, ErrMsg: "用户不存在"}}
	ErrorOrderRefund         = HttpErr{HttpSC: http.StatusOK, Err: Err{Code: 10024, ErrMsg: "退款单不存在"}}
)
